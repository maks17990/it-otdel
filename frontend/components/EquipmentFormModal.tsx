    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <InputField name="location" value={form.location} onChange={handleChange} placeholder="Местоположение" label="Местоположение" />
...
const InputField = React.forwardRef<HTMLInputElement, InputFieldProps>(function InputField(
  ...
  return (
    <div>
      {label && <label htmlFor={props.name} className="block text-sm text-cyan-200 mb-1 font-medium">{label}</label>}
      <input
        {...props}
        ref={ref}
