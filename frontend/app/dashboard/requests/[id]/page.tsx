...
function RatingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#212d44] p-8 rounded-2xl shadow-2xl min-w-[320px] max-w-[94vw]">
        <h2 className="text-xl font-bold mb-4 text-cyan-300">Пожалуйста, оцените работу по заявке</h2>
        <div className="mb-4">
          ...
          <div className="flex gap-2">
            {[1, 2, 3, 4, 5].map(n => (
              <button
                key={n}
                className={`text-3xl ${n <= localRating ? 'text-yellow-400' : 'text-gray-400'}`}
...
export default function RequestDetailsPage() {
  ...
  // Для хранения оценки/отзыва из модалки
